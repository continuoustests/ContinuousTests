...
{
    [TestFixture]
    public class when_build_test_run_information_with_nonempty_setup
    {
            ...
            var entries = new[]
                              {
                                  ...
                                  new ProfilerEntry {Type = ProfileType.Leave, Functionid = 2, Method = "Method2", Runtime = "Method2", Sequence = 5},
                                  new ProfilerEntry {Type = ProfileType.Leave, Functionid = 1, Method = "Setup", Runtime = "Setup", Sequence = 6},
