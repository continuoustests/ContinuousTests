...
namespace AutoTest.TestRunners.XUnit2.Tests
{
    ...
    public class RunnerTests
    {
        ...
        {
            var options = new RunSettings(new AssemblyOptions(Path.GetFullPath(@"AutoTest.TestRunners.XUnit2.Tests.TestResource.dll")), new string[0], null);
        ...
        {
            var assemblyOptions = new AssemblyOptions(Path.GetFullPath(@"AutoTest.TestRunners.XUnit2.Tests.TestResource.dll"));
            assemblyOptions.AddTest("AutoTest.TestRunners.XUnit2.Tests.TestResource.Class1.Should_pass");
        ...
        {
            var assemblyOptions = new AssemblyOptions(Path.GetFullPath(@"AutoTest.TestRunners.XUnit2.Tests.TestResource.dll"));
            assemblyOptions.AddMember("AutoTest.TestRunners.XUnit2.Tests.TestResource.Class1");
        ...
        {
            var assemblyOptions = new AssemblyOptions(Path.GetFullPath(@"AutoTest.TestRunners.XUnit2.Tests.TestResource.dll"));
            assemblyOptions.AddNamespace("AutoTest.TestRunners.XUnit2.Tests.TestResource.Anothernamespace");
